...
class TrelloControllerTest {
    ...
    void shouldCreateTrelloCard() throws Exception {
        ...
        TrelloBadgeDto trelloBadgeDto = new TrelloBadgeDto(3, new TrelloAttachmentsByTypeDto(new TrelloTrelloDto(1, 1)));
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("232", "Test", trelloBadgeDto,"http://test.com");
        ...
        mockMvc
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.badges.votes", Matchers.is(trelloBadgeDto.getVotes())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.badges.attachmentsByType.trello.board", Matchers.is(trelloBadgeDto.getAttachmentsByType().getTrello().getBoard())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.badges.attachmentsByType.trello.card", Matchers.is(trelloBadgeDto.getAttachmentsByType().getTrello().getCard())))
